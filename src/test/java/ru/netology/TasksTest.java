...
public class TasksTest {
    ...
    public void testMatchesReturnsTrueWhenQueryInTitle() {
        SimpleTask task = new SimpleTask(1, "interesting task");
        String query = "task";
    ...
    public void testMatchesReturnsTrueWhenQueryInTopic() {
        Meeting meeting = new Meeting(1, "interesting topic", "new project", "2023-05-20T08:00:00Z");
        String query = "topic";
